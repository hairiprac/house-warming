...
const KAKAO_URL =
  "https://map.kakao.com/?urlX=506110.9999999995&urlY=1107805&urlLevel=3&itemId=1259903811&q=%ED%94%84%EB%A0%88%EC%8A%A4%ED%8B%B0%EC%A7%80%EC%84%9C%EC%B4%88&srcid=1259903811&map_type=TYPE_MAP"
    ...
    <PageLayout>
      ...
      <div className="flex flex-col items-start w-full">
        <div className="px-8 pt-8 pb-6 w-full">
          <KakaoMap placeUrl={KAKAO_URL} className="w-full h-[356px] rounded-[4px]" />
        </div>
